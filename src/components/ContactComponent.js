                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" onChange={this.handleInputChange}
                                    placeholder="First Name" value={this.state.firstname} onBlur={this.handleBlur('firstname')}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    placeholder="Last Name" value={this.state.lastname} onBlur={this.handleBlur('lastname')}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="tel" id="telnum" name="telnum" onChange={this.handleInputChange}
                                    placeholder="Contact Number" value={this.state.telnum} onBlur={this.handleBlur('telnum')}
                                    valid={errors.telnum === ''}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    ...
                                    placeholder="Email" value={this.state.email} onBlur={this.handleBlur('email')}
                                    valid={errors.email === ''}
